...
SMALLCAP_STOCKS = {
    "Engineering Manufacturing 1": {
        ...
        "ACRYSIL.NS":"Acrysil","ADANIPOWER.NS":"Adani Power","ADVENZYMES.NS":"Advanced Enzymes","AEROFLEX.NS":"Aeroflex Industries",
        "AETHER.NS":"Aether Industries","AGCNET.NS":"AGC Networks","AHLEAST.NS":"Asian Hotels East","AHLUCONT.NS":"Ahluwalia Contracts",
        "AIAENG.NS":"AIA Engineering","AIIL.NS":"Ashapura Intimates","AIRAN.NS":"Airan Ltd","AKASH.NS":"Akash Infra-Projects",
        "AKSHARCHEM.NS":"Akshar Chem","AKZOINDIA.NS":"Akzo Nobel India","ALEMBICLTD.NS":"Alembic Pharma","ALICON.NS":"Alicon Castalloy",
        "ALKALI.NS":"Alkali Metals","ALPA.NS":"Alpa Laboratories","ALPHAGEO.NS":"Alphageo India","ALPSINDUS.NS":"Alps Industries"
    },
    "Engineering Manufacturing 2": {
        "AMARAJABAT.NS":"Amara Raja Energy","AMBER.NS":"Amber Enterprises","AMIABLE.NS":"Amiable Logistics","AMJLAND.NS":"AMJ Land Holdings",
        "AMRUTANJAN.NS":"Amrutanjan Health","ANANTRAJ.NS":"Anant Raj","ANDHRSUGAR.NS":"Andhra Sugars","ANGELONE.NS":"Angel One",
        "ANMOL.NS":"Anmol Industries","ANUP.NS":"Anupam Rasayan","APARINDS.NS":"Apar Industries","APCL.NS":"Anjani Portland",
        "APCOTEXIND.NS":"Apcotex Industries","APEX.NS":"Apex Frozen Foods","APLAPOLLO.NS":"APL Apollo Tubes","APOLLO.NS":"Apollo Micro Systems",
        "APOLLOPIPE.NS":"Apollo Pipes","APOLLOTYRE.NS":"Apollo Tyres","APTECHT.NS":"Aptech","ARASU.NS":"Arasu Cable",
        "ARCHIDPLY.NS":"Archidply Industries","ARCHIES.NS":"Archies Ltd","ARL.NS":"Apar Industries","ARMANFIN.NS":"Arman Financial"
    },
    "Engineering Manufacturing 3": {
        "ARROWGREEN.NS":"Arrow Greentech","ARSHIYA.NS":"Arshiya","ARTNIRMAN.NS":"Art Nirman","ARVINDFASN.NS":"Arvind Fashions",
        "ASAHIINDIA.NS":"Asahi India Glass","ASAHISONG.NS":"Asahi Songwon","ASAL.NS":"Automotive Stampings","ASALCBR.NS":"Associated Alcohols",
        "ASHIANA.NS":"Ashiana Housing","ASHIMASYN.NS":"Ashima Ltd","ASHOKA.NS":"Ashoka Buildcon","ASHOKLEY.NS":"Ashok Leyland",
        "ASIANENE.NS":"Asian Energy Services","ASIANHOTNR.NS":"Asian Hotels North","ASIANPAINT.NS":"Asian Paints","ASPINWALL.NS":"Aspinwall",
        "ASTEC.NS":"Astec LifeSciences","ASTERDM.NS":"Aster DM Healthcare","ASTRAL.NS":"Astral Ltd","ASTRAMICRO.NS":"Astra Microwave",
        "ASTRAZEN.NS":"AstraZeneca Pharma","ATAM.NS":"Atam Valves","ATNINTER.NS":"ATN International","ATUL.NS":"Atul Ltd"
    },
    "Engineering Manufacturing 4": {
        "ATULAUTO.NS":"Atul Auto","AURIONPRO.NS":"Aurionpro Solutions","AUSOMENT.NS":"Ausom Enterprise","AUSTRAL.NS":"Austral Coke",
        "AUTOAXLES.NS":"Automotive Axles","AUTOIND.NS":"Autoline Industries","AVALON.NS":"Avalon Technologies","AVANTIFEED.NS":"Avanti Feeds",
        "AVTNPL.NS":"AVT Natural Products","AWL.NS":"Adani Wilmar","AXISBANK.NS":"Axis Bank","AXISCADES.NS":"Axiscades Engineering",
        "AXISGOLD.NS":"Axis Gold","AYMSYNTEX.NS":"AYM Syntex","AZAD.NS":"Azad Engineering","BAGFILMS.NS":"BAG Films",
        "BAJAJELEC.NS":"Bajaj Electricals","BAJAJHIND.NS":"Bajaj Hindusthan Sugar","BAJFINANCE.NS":"Bajaj Finance","BALAJITELE.NS":"Balaji Telefilms",
        "BALAXI.NS":"Balaxi Ventures","BALKRISHNA.NS":"Balkrishna Paper","BALMLAWRIE.NS":"Balmer Lawrie","BALPHARMA.NS":"Bal Pharma"
    },
    "Chemicals Pharmaceuticals 1": {
        "BANCOINDIA.NS":"Banco Products","BANG.NS":"Bang Overseas","BANKBARODA.NS":"Bank of Baroda","BANKINDIA.NS":"Bank of India",
        "BANSWRAS.NS":"Banswara Syntex","BARBEQUE.NS":"Barbeque Nation","BASF.NS":"BASF India","BATAINDIA.NS":"Bata India",
        "BBOX.NS":"Black Box","BBL.NS":"Bharat Bijlee","BBTC.NS":"Bombay Burmah","BCG.NS":"Brightcom Group",
        "BCP.NS":"Banco Products","BDL.NS":"Bharat Dynamics","BEEKAY.NS":"Beekay Steel","BEL.NS":"Bharat Electronics",
        "BELSTAR.NS":"Belstar Microfinance","BEML.NS":"BEML","BEPL.NS":"Bhansali Engineering","BERGEPAINT.NS":"Berger Paints",
        "BFINVEST.NS":"BF Investment","BGRENERGY.NS":"BGR Energy Systems","BHAGERIA.NS":"Bhageria Industries","BHAGYANGR.NS":"Bhagiradha Chemicals"
    },
    "Chemicals Pharmaceuticals 2": {
        "BHANDARI.NS":"Bhandari Hosiery","BHARATFORG.NS":"Bharat Forge","BHARATGEAR.NS":"Bharat Gears","BHARATWIRE.NS":"Bharat Wire Ropes",
        "BHARTIARTL.NS":"Bharti Airtel","BHEL.NS":"BHEL","BILENERGY.NS":"Bil Energy Systems","BIOCON.NS":"Biocon",
        "BIRLACABLE.NS":"Birla Cable","BIRLAMONEY.NS":"Aditya Birla Money","BIRLACORPN.NS":"Birla Corporation","BIRLATYRE.NS":"Birla Tyres",
        "BKM.NS":"Bkmindspace","BLACKROSE.NS":"Blackrose Industries","BLAL.NS":"BEML Land Assets","BLISSGVS.NS":"Bliss GVS Pharma",
        "BLKASHYAP.NS":"B L Kashyap","BLUEBLENDS.NS":"Blue Blends","BLUECOAST.NS":"Blue Coast Hotels","BLUEDART.NS":"Blue Dart Express",
        "BLUEJET.NS":"Blue Jet Healthcare","BLUESTARCO.NS":"Blue Star","BODALCHEM.NS":"Bodal Chemicals","BOMDYEING.NS":"Bombay Dyeing"
    },
    "Chemicals Pharmaceuticals 3": {
        "BOROLTD.NS":"Borosil Ltd","BOSCHLTD.NS":"Bosch","BPCL.NS":"BPCL","BRFL.NS":"Bombay Rayon",
        "BRIGADE.NS":"Brigade Enterprises","BRITANNIA.NS":"Britannia","BRO.NS":"Brigade Road","BSE.NS":"BSE Ltd",
        "BSHSL.NS":"Bombay Super Hybrid","BSL.NS":"BSL Ltd","BSOFT.NS":"Birlasoft","BTML.NS":"Bodal Trading",
        "BURNPUR.NS":"Burnpur Cement","BUTTERFLY.NS":"Butterfly Gandhimathi","CADILAHC.NS":"Cadila Healthcare","CADSYS.NS":"Cadsys India",
        "CALSOFT.NS":"California Software","CAMLINFINE.NS":"Camlin Fine Sciences","CAMPUS.NS":"Campus Activewear","CANBK.NS":"Canara Bank",
        "CANFINHOME.NS":"Can Fin Homes","CANTABIL.NS":"Cantabil Retail","CAPF.NS":"Capital First","CAPLIPOINT.NS":"Caplin Point"
    },
    "Chemicals Pharmaceuticals 4": {
        "CAPTRUST.NS":"Capital Trust","CARBORUNIV.NS":"Carborundum Universal","CARERATING.NS":"CARE Ratings","CARGEN.NS":"Cargen Drugs",
        "CARYSIL.NS":"Carysil","CASTROLIND.NS":"Castrol India","CCCL.NS":"Consolidated Construction","CCL.NS":"CCL Products",
        "CDSL.NS":"CDSL","CEATLTD.NS":"CEAT","CELEBRITY.NS":"Celebrity Fashions","CELLO.NS":"Cello World",
        "CENTENKA.NS":"Century Enka","CENTUM.NS":"Centum Electronics","CENTURY.NS":"Century Textiles","CENTURYPLY.NS":"Century Plyboards",
        "CERA.NS":"Cera Sanitaryware","CEREBRAINT.NS":"Cerebra Integrated","CESC.NS":"CESC","CGCL.NS":"Capri Global",
        "CGPOWER.NS":"CG Power","CHAMBLFERT.NS":"Chambal Fertilizers","CHEMBOND.NS":"Chembond Chemicals","CHEMCON.NS":"Chemcon Speciality"
    },
    "Textiles Consumer Goods 1": {
        "CHEMFAB.NS":"Chemfab Alkalis","CHEMPLASTS.NS":"Chemplast Sanmar","CHENNPETRO.NS":"Chennai Petroleum","CHOLAFIN.NS":"Cholamandalam Investment",
        "CHOLAHLDNG.NS":"Cholamandalam Financial","CIEINDIA.NS":"CIE Automotive","CIGNITITEC.NS":"Cigniti Technologies","CINELINE.NS":"Cineline India",
        "CINEVISTA.NS":"Cinevista","CIPLA.NS":"Cipla","CLNINDIA.NS":"Clariant Chemicals","CLSEL.NS":"Chaman Lal Setia",
        "CMICABLES.NS":"CMI Ltd","CMNL.NS":"CMI Ltd","CMDL.NS":"CMDL","COALINDIA.NS":"Coal India",
        "COASTCORP.NS":"Coastal Corporation","COFFEEDAY.NS":"Coffee Day Enterprises","COFORGE.NS":"Coforge","COLPAL.NS":"Colgate Palmolive",
        "COMPINFO.NS":"Compuage Infocom","COMPUSOFT.NS":"Compucom Software","CONCOR.NS":"Container Corporation","CONFIPET.NS":"Confidence Petroleum"
    },
    "Textiles Consumer Goods 2": {
        "CONSOFINVT.NS":"Consolidated Finvest","CONTROLS.NS":"Control Print","COOKCAST.NS":"Cookcast","CORALFINAC.NS":"Coral India Finance",
        "CORDSCABLE.NS":"Cords Cable","COROMANDEL.NS":"Coromandel International","COROENGG.NS":"Coromandel Engineering","CORPBANK.NS":"Corporation Bank",
        "COSMOFILMS.NS":"Cosmo Films","COUNCODOS.NS":"Country Condo's","COX&KINGS.NS":"Cox & Kings","CPSEETEC.NS":"CPS EeeTech",
    ...
    "Textiles Consumer Goods 4": {
        "DCXINDIA.NS":"DCX Systems","DDL.NS":"Dhunseri Ventures","DEBOCK.NS":"De Nora India","DÉCOR.NS":"Decor Exim",
        "DEEPAKFERT.NS":"Deepak Fertilizers","DEEPAKNTR.NS":"Deepak Nitrite","DEEPIND.NS":"Deepak Spinners","DELTACORP.NS":"Delta Corp",
        "DENDRO.NS":"Dendro Technologies","DENORA.NS":"De Nora India","DENZYME.NS":"Dezyne E-Commerce","DHANBANK.NS":"Dhanalakshmi Bank",
        "DHANUKA.NS":"Dhanuka Agritech","DHARAMSI.NS":"Dharamsi Morarji","DHAMPURSUG.NS":"Dhampur Sugar","DHANVARSHA.NS":"Dhanvarsha Finvest",
        "DHUNINV.NS":"Dhunseri Investments","DIACABS.NS":"Diamond Cables","DIAMINESQ.NS":"Diamines Chemicals","DIGJAM.NS":"Digjamlimited"
    },
    "IT Software Services 1": {
        "DIGISPICE.NS":"DiGiSPICE Technologies","DIGJAMLMTD.NS":"Digjamlimited","DION.NS":"Dion Global Solutions","DISHMAN.NS":"Dishman Carbogen",
        "DIVGIITTS.NS":"Divgi TorqTransfer","DISHTV.NS":"Dish TV India","DIVISLAB.NS":"Divi's Laboratories","DIXON.NS":"Dixon Technologies",
        "DLF.NS":"DLF","DLINKINDIA.NS":"D-Link India","DMART.NS":"Avenue Supermarts","DMCC.NS":"DMCC Speciality",
        "DOLLAR.NS":"Dollar Industries","DOLAT.NS":"Dolat Investments","DONEAR.NS":"Donear Industries","DOUBLECON.NS":"Double Con",
        "DHANBANK.NS":"Dhanalakshmi Bank","DREDGECORP.NS":"Dredging Corporation","DRREDDY.NS":"Dr Reddy's Labs","DUCON.NS":"Ducon Infratechnologies",
        "DUCOL.NS":"Ducol Organics","DUMMETT.NS":"Dummett Coote","DWARKESH.NS":"Dwarkesh Sugar","DYNAMATECH.NS":"Dynamatic Technologies"
    },
    "IT Software Services 2": {
        "DYNAMIND.NS":"Dynamatic Technologies","EASEMYTRIP.NS":"EaseMyTrip","EASTSILK.NS":"Eastern Silk","EASUNREYRL.NS":"Easun Reyrolle",
        "EBBCO.NS":"EbbCo Ventures","ECLFINANCE.NS":"Edelweiss Capital","ECLERX.NS":"eClerx Services","ECOBOARD.NS":"Eco Board",
        "EDELWEISS.NS":"Edelweiss Financial","EDUCOMP.NS":"Educomp Solutions","EICHERMOT.NS":"Eicher Motors","EIDPARRY.NS":"EID Parry",
        "EIFFL.NS":"Euro India Fresh Foods","EIHAHOTELS.NS":"EIH Associated Hotels","EIHOTEL.NS":"EIH Ltd","EIMCOELECO.NS":"Eimco Elecon",
        "EKENNIS.NS":"Ekennis Software","ELECTROCAST.NS":"Electrocast Sales","ELECON.NS":"Elecon Engineering","ELECTHERM.NS":"Electrotherm India",
        "ELGIRUBCO.NS":"Elgi Rubber","ELGIEQUIP.NS":"Elgi Equipments","ELIN.NS":"Elin Electronics","EMAMILTD.NS":"Emami"
    },
    "IT Software Services 3": {
        "EMAMIPAP.NS":"Emami Paper","EMAMIREAL.NS":"Emami Realty","EMIRATE.NS":"Emirate Securities","EMMBI.NS":"Emmbi Industries",
        "EMSLIMITED.NS":"EMS Ltd","ENIL.NS":"Entertainment Network","EPACK.NS":"Epack Durables","EQUITAS.NS":"Equitas Holdings",
        "EQUIPPP.NS":"Equippp Social","ERIS.NS":"Eris Lifesciences","EROSMEDIA.NS":"Eros International","ESABINDIA.NS":"ESAB India",
        "ESCORTS.NS":"Escorts Kubota","ESSARSHPNG.NS":"Essar Shipping","ESTER.NS":"Ester Industries","ETECHNO.NS":"Electrotherm Technologies",
        "EUROCERA.NS":"Euro Ceramics","EUROTEXIND.NS":"Eurotex Industries","EVEREADY.NS":"Eveready Industries","EVERESTIND.NS":"Everest Industries",
        "EXCEL.NS":"Excel Crop Care","EXCELINDUS.NS":"Excel Industries","EXIDEIND.NS":"Exide Industries","EXPLEOSOL.NS":"Expleo Solutions"
    },
    "IT Software Services 4": {
        "FACT.NS":"Fertilizers And Chemicals","FAGBEARING.NS":"Schaeffler India","FAIRCHEM.NS":"Fairchem Speciality","FAZE3.NS":"Faze Three",
        "FCL.NS":"Fineotex Chemical","FEDERALBNK.NS":"Federal Bank","FEL.NS":"Future Enterprises","FELDVR.NS":"Future Enterprises DVR",
        "FENTURA.NS":"Fentura Financial","FCSSOFT.NS":"FCS Software","FIBERWEB.NS":"Fiberweb India","FIEMIND.NS":"Fiem Industries",
        "FILATEX.NS":"Filatex India","FINCABLES.NS":"Finolex Cables","FINOPB.NS":"Fino Payments","FINPIPE.NS":"Finolex Industries",
        "FINEORG.NS":"Fine Organic","FINKURVE.NS":"Finkurve Financial","FINOL.NS":"Finolex Industries","FIRSTCRY.NS":"FirstCry Baby",
        "FIRSTSOUR.NS":"Firstsource Solutions","FIVESTAR.NS":"Five Star Business","FLFL.NS":"Future Lifestyle","FLIP.NS":"Flip Media"
    },
    "Infrastructure Real Estate 1": {
        "FLUOROCHEM.NS":"Gujarat Fluorochemicals","FOCUSLIGHT.NS":"Focus Lighting","FOMENTO.NS":"Fomento Resorts","FOODSIN.NS":"Foods & Inns",
        "FORCE.NS":"Force Motors","FORCEMOT.NS":"Force Motors","FORTIS.NS":"Fortis Healthcare","FOSECOIND.NS":"Foseco India",
        "FRETAIL.NS":"Future Retail","FRIEDBERG.NS":"Friedberg Direct","FSC.NS":"Future Supply Chain","FSL.NS":"Firstsource Solutions",
        "GABRIEL.NS":"Gabriel India","GAEL.NS":"Gujarat Ambuja Exports","GAIL.NS":"GAIL India","GALAXYSURF.NS":"Galaxy Surfactants",
        "GALLANTT.NS":"Gallantt Ispat","GANDHAR.NS":"Gandhar Oil Refinery","GANDHITUBE.NS":"Gandhi Special Tubes","GANESHHOUC.NS":"Ganesh Housing",
        "GANECOS.NS":"Ganesha Ecosphere","GANESHBE.NS":"Ganesh Benzoplast","GARFIBRES.NS":"Garware Technical","GATI.NS":"Gati Ltd"
    },
    "Infrastructure Real Estate 2": {
        ...
        "GESHIP.NS":"Great Eastern Shipping","GET&D.NS":"GE T&D India","GETALONG.NS":"Getalong Enterprises","GHCL.NS":"GHCL Ltd",
    ...
    "Energy Utilities 2": {
        "HBLPOWER.NS":"HBL Power Systems","HBSL.NS":"HB Stockholdings","HCC.NS":"Hindustan Construction","HCL-INSYS.NS":"HCL Infosystems",
        "HCLTECH.NS":"HCL Technologies","HEG.NS":"HEG Ltd","HEIDELBERG.NS":"HeidelbergCement India","HELIOS.NS":"Helios Matheson",
        "HERANBA.NS":"Heranba Industries","HERCULES.NS":"Hercules Hoists","HERITGFOOD.NS":"Heritage Foods","HEROMOTOCO.NS":"Hero MotoCorp",
        "HESTERBIO.NS":"Hester Biosciences","HEUBACHIND.NS":"Heubach Colorants","HEXATRADEX.NS":"Hexa Tradex","HEXAWARE.NS":"Hexaware Technologies",
        "HFCL.NS":"HFCL Ltd","HGS.NS":"Hinduja Global","HIKAL.NS":"Hikal Ltd","HIL.NS":"HIL Ltd",
        "HILTON.NS":"Hilton Metal","HIMATSEIDE.NS":"Himatsingka Seide","HINDCOMPOS.NS":"Hindustan Composites","HINDCOPPER.NS":"Hindustan Copper"
    },
    "Energy Utilities 3": {
        "HINDDORROL.NS":"Hinddorrol","HINDMOTORS.NS":"Hindustan Motors","HINDNATGLS.NS":"Hindon Natural","HINDOILEXP.NS":"Hindustan Oil Exploration",
        "HINDPETRO.NS":"Hindustan Petroleum","HINDUNILVR.NS":"Hindustan Unilever","HINDWAREAP.NS":"Hindware Appliances","HINDZINC.NS":"Hindustan Zinc",
        "HIRECT.NS":"Hind Rectifiers","HITECH.NS":"Hitech Corporation","HITECHCORP.NS":"Hitech Corporation","HITECHGEAR.NS":"Hitachi Energy",
        "HLEGLAS.NS":"HLE Glascoat","HMT.NS":"HMT Ltd","HMVL.NS":"Hindustan Media","HNDFDS.NS":"Hindustan Foods",
        "HOMEFIRST.NS":"Home First Finance","HONAUT.NS":"Honeywell Automation","HONDAPOWER.NS":"Honda Power","HOTELRUGBY.NS":"Hotel Rugby"
    },
    "Energy Utilities 4": {
        "HOVS.NS":"HOV Services","HPAL.NS":"HP Adhesives","HPL.NS":"HPL Electric","HSCL.NS":"Himadri Speciality",
        "HTMEDIA.NS":"HT Media","HUDCO.NS":"HUDCO","HUDCO.NS":"HUDCO","HUHTAMAKI.NS":"Huhtamaki India",
        "ICICIBANK.NS":"ICICI Bank","ICICIGI.NS":"ICICI Lombard","ICICIPRULI.NS":"ICICI Prudential","ICIL.NS":"Indo Count",
        "ICRA.NS":"ICRA Ltd","IDBI.NS":"IDBI Bank","IDEA.NS":"Vodafone Idea","IDFC.NS":"IDFC Ltd",
        "IDFCFIRSTB.NS":"IDFC First Bank","IEX.NS":"Indian Energy Exchange","IFBAGRO.NS":"IFB Agro","IFBIND.NS":"IFB Industries"
    },
    "Banking Financial Services 1": {
        "IFCI.NS":"IFCI Ltd","IFGLEXPOR.NS":"IFGL Refractories","IGARASHI.NS":"Igarashi Motors","IGL.NS":"Indraprastha Gas",
        "IGPL.NS":"IG Petrochemicals","IITL.NS":"Industrial Investment","IL&FSENGG.NS":"IL&FS Engineering","IL&FSTRANS.NS":"IL&FS Transportation",
    ...
    "Food Beverages Agriculture 1": {
        ...
        "JINDALPOLY.NS":"Jindal Poly Films","JINDALSAW.NS":"Jindal Saw","JINDALSTEL.NS":"Jindal Steel","JINDWORLD.NS":"Jindal Worldwide",
    ...
    "Retail Media Entertainment 1": {
        ...
        "KPRMILL.NS":"KPR Mill","KRBL.NS":"KRBL Ltd","KREBSBIO.NS":"Krebs Biochemicals","KRIINFRA.NS":"K Raheja","KRIDHANINF.NS":"Kridhan Infra",
        "KRISHANA.NS":"Krishana Phoschem","KRITI.NS":"Kriti Industries","KRITIKA.NS":"Kritika Wires","KRITINUT.NS":"Kriti Nutrients",
        "KRONS.NS":"Kronox Lab Sciences","KRSNAA.NS":"Krsnaa Diagnostics","KSB.NS":"KSB Ltd","KSE.NS":"KSS Ltd",
        "KSK.NS":"KSK Energy Ventures","KTKBANK.NS":"Karnataka Bank","KUBOTA.NS":"Escorts Kubota","KUMARASWA.NS":"Kumar Swamy Construction",
        "KUMARKS.NS":"Kumar Swamy","KUMBHAT.NS":"Kumbhat Financial","KUNDANCARE.NS":"Kundan Care","KUPRIYA.NS":"Kupriya Industries"
    },
    "Retail Media Entertainment 2": {
        "KUSTODIAN.NS":"Kustodian Securities","KWALITY.NS":"Kwality Ltd","KWALIT.NS":"Kwalitex Industries","L&TFH.NS":"L&T Finance Holdings",
        "L&TFHIN.NS":"L&T Finance","L&T.NS":"Larsen & Toubro","LA.NS":"Laurus Labs","LAKPRE.NS":"Lakshmi Precision",
        "LAKSHMIEFL.NS":"Lakshmi Energy","LALPATHLAB.NS":"Dr Lal PathLabs","LAMBODHARA.NS":"Lambodhara Textiles","LANCER.NS":"Lancer Container",
        "LANDMARK.NS":"Landmark Property","LAOPALA.NS":"La Opala RG","LASA.NS":"Lasa Supergenerics","LATENTVIEW.NS":"LatentView Analytics",
        "LAURUSLABS.NS":"Laurus Labs","LAXMIMACH.NS":"Lakshmi Machine","LCCINFOTEC.NS":"LCC Infotech","LCC.NS":"LCC Infotech",
        "LEMONTREE.NS":"Lemon Tree Hotels","LEXUS.NS":"Lexus Granito","LFIC.NS":"Lakshmi Finance","LG.NS":"LG Balakrishnan"
    }
}
...
st.markdown('<div class="main-header"><h1>SMALLCAP VALUATION</h1><p>700+ High Growth Stocks | Professional Analysis</p></div>', unsafe_allow_html=True)
...
if 'analyze' in st.session_state:
    ...
    with col1:
        st.success("**Features:** 700+ smallcap stocks, High growth potential, Real-time analysis, PDF reports")
    with col2:
        st.warning("**Tip:** Smallcaps are more volatile. Data cached for 2 hours for faster access!")

st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>NYZTrade Smallcap Platform | 700+ Stocks | Educational Tool</div>", unsafe_allow_html=True)
